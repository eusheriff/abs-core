...
exports.whatsappBotPolicy = exports.WhatsAppBotPolicy = void 0;
...
class WhatsAppBotPolicy {
    constructor() {
        this.name = 'WhatsAppBotPolicy';
    }
    evaluate(event, proposal) {
        ...
        if (!payload || !payload.context) {
            ...
            return {
                decision: (proposal.recommended_action || 'escalate'),
...
exports.WhatsAppBotPolicy = WhatsAppBotPolicy;
// Export singleton
exports.whatsappBotPolicy = new WhatsAppBotPolicy();
