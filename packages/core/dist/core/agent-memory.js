...
exports.getAgentRiskProfile = getAgentRiskProfile;
exports.calculateAdaptiveRisk = calculateAdaptiveRisk;
exports.getAgentStats = getAgentStats;
exports.clearAgentStats = clearAgentStats;
// In-memory store (can be replaced with DB adapter)
const agentStats = new Map();
/**
 * Record an action outcome for an agent
 */
function recordAction(agentId, outcome) {
 ...
 */
function getAgentRiskProfile(agentId) {
 ...
 */
function calculateAdaptiveRisk(agentId, baseScore, sequenceBonus = 0) {
 ...
 */
function clearAgentStats(agentId) {
    if (agentId) {
