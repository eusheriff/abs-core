...
exports.CODE_SAFETY_POLICIES = void 0;
/**
...
function matchGlob(path, pattern) {
    ...
    if (pattern.startsWith("**/")) {
        ...
        if (suffix.includes("*")) {
            const suffixRegex = new RegExp("^" + suffix.replace(/\./g, "\\.").replace(/\*/g, ".*") + "$");
...
exports.CODE_SAFETY_POLICIES = [
    {
        name: "protected-files",
        description: "Blocks modifications to sensitive files (.env, secrets, keys)",
    ...
    },
    {
        ...
        description: "Blocks dangerous terminal commands (rm -rf, DROP TABLE, etc.)",
        evaluate: (proposal, event) => {
            const payload = event.payload;
    ...
    },
    {
        ...
        evaluate: (proposal, event) => {
            ...
            if (!lineCount || lineCount <= MAX_LINES_PER_EDIT)
                return "ALLOW";
            return {
...
exports.default = exports.CODE_SAFETY_POLICIES;
