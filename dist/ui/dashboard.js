...
const Dashboard = (props) => {
    return (0, layout_1.Layout)({
        title: 'Observability',
        head: (0, html_1.html) `<meta http-equiv="refresh" content="2">`, // Simple Auto-Refresh
        children: (0, html_1.html) `
            <header>
                <div>
            ...
            if (log.execution_status === 'EXECUTED')
                execBadgeColor = '#238636'; // Green
            if (log.execution_status === 'FAILED')
                execBadgeColor = '#da3633'; // Red
            ...
            ${props.logs.length === 0 ? (0, html_1.html) `
